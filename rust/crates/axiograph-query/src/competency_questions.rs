...
pub struct CompetencyCoverageWithTrustV1 {
    ...
    pub cost: f64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub runtime_theory_check: Option<axiograph_tooling_overlays::RuntimeTheoryCheckSummaryV1>,
    #[serde(default)]
...
) -> Result<crate::competency_questions::CompetencyCoverageSummaryV1> {
    let eval = evaluate_competency_questions_with_trust(db, questions)?;
    Ok(crate::competency_questions::CompetencyCoverageSummaryV1 {
        total: eval.total,
        ...
        questions: eval
            ...
            .into_iter()
            .map(
                |q| crate::competency_questions::CompetencyQuestionResultV1 {
                    name: q.name,
                    rows: q.rows,
                    min_rows: q.min_rows,
...
"#,
        ...
        let question = CompetencyQuestionV1 {
            ...
            authoring: Some(
                crate::competency_questions::CompetencyQuestionAuthoringHintsV1 {
