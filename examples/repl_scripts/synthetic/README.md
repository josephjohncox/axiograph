...
Keep scripts here only when they demonstrate a REPL feature that is hard to
show with a canonical module. If a script teaches a durable ontology workflow,
convert it to canonical `.axi` import plus typed reports and move it back up one
directory.
