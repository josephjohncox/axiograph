...
--
-- - the finite canonical model materializes inverse/transitive tuples explicitly,
-- - the checker then verifies keys/functionals against that finite closure,
...
schema Fibered:
  ...
  relation Accessible(from: Node, to: Node, ctx: Context @context, time: Time @temporal, witness: Evidence @evidence)
  ...
  relation Relationship(a: Node, b: Node, kind: RelKind, ctx: Context @context, witness: Evidence @evidence)

  -- A simple symmetric relation scoped to a context.
  relation Knows(a: Node, b: Node, ctx: Context @context)
...
instance SmallFiberedWorld of Fibered:
  ...
  -- The finite model explicitly materializes the transitive tuple.
  Accessible = {
    (from=Alice, to=Bob, ctx=Census2020, time=T2020, witness=Ev0),
    (from=Bob, to=Carol, ctx=Census2020, time=T2020, witness=Ev1),
    (from=Alice, to=Carol, ctx=Census2020, time=T2020, witness=Ev2),
  ...
  -- Only Friend/Colleague relationships are symmetric, with both directions
  -- explicit in the finite model.
  Relationship = {
    (a=Alice, b=Bob, kind=Friend, ctx=Census2020, witness=Ev0),
    (a=Bob, b=Alice, kind=Friend, ctx=Census2020, witness=Ev0),
    (a=Bob, b=Carol, kind=Rival, ctx=Census2020, witness=Ev1),
    (a=Alice, b=Carol, kind=Colleague, ctx=FamilyTree2023, witness=Ev2),
    (a=Carol, b=Alice, kind=Colleague, ctx=FamilyTree2023, witness=Ev2)
  }

  Knows = {
    (a=Alice, b=Bob, ctx=Census2020),
    (a=Bob, b=Alice, ctx=Census2020),
    (a=Carol, b=Alice, ctx=FamilyTree2023),
    (a=Alice, b=Carol, ctx=FamilyTree2023)
  }
